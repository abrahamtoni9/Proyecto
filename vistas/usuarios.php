...
//si no se realiza el login entonces se debe redireccionar a la pagina login
//si existe nos muestra toda la vista  del modulo  usuario
  ...
  <!--Contenido-->
      ...
      <div class="content-wrapper">        
        ...
        <section class="content">
              ...
              <!-- creamos el div para recibir resultado para mostrar en el mensaje personalizado -->
    ...
    <div id="usuarioModal" class="modal fade">
      ...
      <div class="modal-dialog">
         ...
         <form method="post" id="usuario_form">
          ...
          <textarea cols="82" rows="3" id="direccion" name="direccion"  placeholder="Direccion ..." required pattern="^[a-zA-Z0-9_áéíóúñ°\s]{0,200}$">
          </textarea>
          <br />
...
<?php
     ...
     //en caso de que no se logeo redirecciona al login
     } else {
